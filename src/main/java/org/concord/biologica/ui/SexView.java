//
// Class : SexView - the main sex view that holds the subviews for creating offspring, doing
...
implements PropertyChangeListener, ActionListener, ComponentListener
{
    ...
    **/
    private int organismViewHeightPercentage = 50;
    ...
    **/
    private SexOrganismView motherOrganismView;

    /**
     * Offspring organism view
    **/
    private SexOrganismView offspringOrganismView;

    /**
     * Father organism view
    **/
    private SexOrganismView fatherOrganismView;
    ...
    **/
    public SexView()
    {
        ...
        setSexViewMode(SEX_VIEW_MODE_ALL_VIEWS);
        setGameteSelectMode(SexView.MANUAL_GAMETE_SELECT);
    ...
    **/
    public void setCharacteristicsTextVisible(boolean aCharacteristicsTextVisible)
    {
        ...
        motherOrganismView.setCharacteristicsTextVisible(aCharacteristicsTextVisible);
        offspringOrganismView.setCharacteristicsTextVisible(aCharacteristicsTextVisible);
        fatherOrganismView.setCharacteristicsTextVisible(aCharacteristicsTextVisible);

        // Set this view's value
        super.setCharacteristicsTextVisible(aCharacteristicsTextVisible);
    }
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setNameTextVisible(aNameTextVisible);
        offspringOrganismView.setNameTextVisible(aNameTextVisible);
        fatherOrganismView.setNameTextVisible(aNameTextVisible);

        // Set this view's value
        super.setNameTextVisible(aNameTextVisible);
    }
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setSexTextVisible(aSexTextVisible);
        offspringOrganismView.setSexTextVisible(aSexTextVisible);
        fatherOrganismView.setSexTextVisible(aSexTextVisible);

        // Set this view's value
        super.setSexTextVisible(aSexTextVisible);
    }
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setSpeciesTextVisible(aSpeciesTextVisible);
        offspringOrganismView.setSpeciesTextVisible(aSpeciesTextVisible);
        fatherOrganismView.setSpeciesTextVisible(aSpeciesTextVisible);

        // Set this view's value
        super.setSpeciesTextVisible(aSpeciesTextVisible);
    }
    ...
    **/
    public void setSexViewMode(int aSexViewMode)
    {
        ...
        switch (aSexViewMode)
        {
            ...
            case SEX_VIEW_MODE_SIX_VIEWS:
                sexViewMode = aSexViewMode;
                {
                    ...
                    if (gameteSelectMode == SexView.AUTO_GAMETE_SELECT && selectGameteButtonVisible)
			    	{
        ...
        // Notify listeners
        if (oldSexViewMode != sexViewMode)
        {
            changes.firePropertyChange(UIProp.SEX_VIEW_MODE,
                                       new Integer(oldSexViewMode),
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setOrganismImageSize(anOrganismImageSize);
        offspringOrganismView.setOrganismImageSize(anOrganismImageSize);
        fatherOrganismView.setOrganismImageSize(anOrganismImageSize);

        // Set this view's value
        super.setOrganismImageSize(anOrganismImageSize);
    }
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setTextIndent(aTextIndent);
        offspringOrganismView.setTextIndent(aTextIndent);
        fatherOrganismView.setTextIndent(aTextIndent);

        // Set this view's value
        super.setTextIndent(aTextIndent);
    }
    ...
    **/
    ...
    {
        // Set child view values
        motherOrganismView.setTextLineSpacing(aTextLineSpacing);
        offspringOrganismView.setTextLineSpacing(aTextLineSpacing);
        fatherOrganismView.setTextLineSpacing(aTextLineSpacing);

        // Set this view's value
        super.setTextLineSpacing(aTextLineSpacing);
    }
    ...
    **/
    private void updateState()
    {
        ...
        {
            case SEX_VIEW_MODE_NO_VIEWS:
                motherOrganismView.setOrganism(null);
                offspringOrganismView.setFertilizationModel(null);
                fatherOrganismView.setOrganism(null);
            ...
            case SEX_VIEW_MODE_SIX_VIEWS:
                motherOrganismView.setOrganism(motherOrganism);
                offspringOrganismView.setFertilizationModel(offspringFertilizationModel);
                fatherOrganismView.setOrganism(fatherOrganism);
    ...
    **/
    public void toolChanged(int aTool)
    {
        ...
        // Tell the organism subviews but not the meiosis and fertilization subviews
        motherOrganismView.toolChanged(activeTool);
        offspringOrganismView.toolChanged(activeTool);
        fatherOrganismView.toolChanged(activeTool);
